                    ...
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          ...
                          <li
                            class="lh-menu-stair"
                            v-for="cahpter in chapterVideoList"
                            :key="cahpter.id"
                          >
                            <a
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li
                                ...
                                v-for="video in cahpter.children"
                                :key="video.id"
                              >
                                <a
...
export default {
  asyncData({ params, error }) {
    return {courseIdIndex: params.id}
  },
  ...
  methods: {
    ...
    createOrders() {
      ...
      orders.createOrders(this.courseIdIndex).then(response => {
        //返回的订单号
        //生成订单后跳转到订单显示页面
    ...
    //获取课程详情
    initCourseInfo() {
      courseApi.getBaseCourseInfo(this.courseIdIndex).then(response => {

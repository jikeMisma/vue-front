                  ...
                  <section class="mt20">
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          <!-- 文件目录 -->
                          <li class="lh-menu-stair" v-for="cahpter in chapterVideoList" :key="cahpter.id">
                            <a href="javascript: void(0)" :title="cahpter.title" class="current-1">
                              <em class="lh-menu-i-1 icon18 mr10"></em>{{cahpter.title}}
                            </a>
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in cahpter.children" :key="video.id">
                                <a :href="'/player/'+video.videoSourceId" title target="_black">
                                  <span class="fr">
